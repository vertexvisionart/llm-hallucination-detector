...
from qa_consistency_verifier import build_feature_name_list, fit_text_vectorizers, transform_text_features


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train no-retrieval QA consistency verifier")
    parser.add_argument(
        "--labels-paths",
        type=str,
        default="artifacts_poc/internal_real_v1.parquet,artifacts_poc/internal_factual_v1.parquet",
    )
    parser.add_argument("--artifacts-dir", type=str, default="detector_artifacts_qa_consistency_v1")
